...
// Prefer clock that never decreases and ignores time suspended.
// Can probably use CLOCK_UPTIME_RAW for non-mac too, but remains to be
// verified.
#if defined(ALLEGRO_MACOSX)
#define CLOCK_ID CLOCK_UPTIME_RAW
#else
